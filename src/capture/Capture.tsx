...
export const Capture: FC = () => {
  ...
  const [title, setTitle] = useState('UBC 2023 Final, Day 1, Match 1')
  const [date, setDate] = useState('2023-12-18')
  const [targetScore, setTargetScore] = useState('1')
  const [topPlayer, setTopPlayer] = useState('Masayuki "Mochy" Mochizuki')
  const [topPlayerShortName, setTopPlayerShortName] = useState('Mochy')
  const [bottomPlayer, setBottomPlayer] = useState('Sander Lylloff')
  const [bottomPlayerShortName, setBottomPlayerShortName] = useState('Sander')
